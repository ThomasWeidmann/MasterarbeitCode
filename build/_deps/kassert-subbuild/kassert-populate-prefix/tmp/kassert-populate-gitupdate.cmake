...
execute_process(
  COMMAND "/usr/bin/git" show-ref "e683aef"
  WORKING_DIRECTORY "/mnt/d/informatik/semester 12/masterarbeit/code/build/_deps/kassert-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("e683aef" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/e683aef")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/informatik/semester 12/masterarbeit/code/build/_deps/kassert-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/informatik/semester 12/masterarbeit/code/build/_deps/kassert-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
